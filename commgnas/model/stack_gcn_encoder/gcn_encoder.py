...
from commgnas.dynamic_configuration import activation_getter
from commgnas.model.stack_gcn_encoder.message_passing_net import MessagePassingNet

from commgnas.datasets.planetoid import Planetoid # for unit test
...
if __name__=="__main__":
    ...
    gnn_architecture = ['gcn', 'sum',  2, 10, 'tanh', 'gcn', 'sum', 2, 5, 'sigmoid']

    MyGNN = GcnEncoder(gnn_architecture, in_feats).to(device)

    output = MyGNN(graph.train_x[0], graph.train_edge_index[0])
